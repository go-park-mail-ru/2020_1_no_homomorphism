...
func (m *MockUseCase) GetTopArtist() ([]models.ArtistAndSubscribers, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUseCaseMockRecorder) GetTopArtist() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTopArtist", reflect.TypeOf((*MockUseCase)(nil).GetTopArtist))
}
