...
func (m *MockUseCase) GetNewestReleases(uID string, begin, end int) ([]models.NewestReleases, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUseCaseMockRecorder) GetNewestReleases(uID, begin, end interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNewestReleases", reflect.TypeOf((*MockUseCase)(nil).GetNewestReleases), uID, begin, end)
}
