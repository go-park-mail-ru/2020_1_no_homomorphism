...
// GetNewestReleases mocks base method
func (m *MockRepository) GetNewestReleases(uID string, begin, end int) ([]models.NewestReleases, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNewestReleases", uID, begin, end)
	ret0, _ := ret[0].([]models.NewestReleases)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetNewestReleases indicates an expected call of GetNewestReleases
func (mr *MockRepositoryMockRecorder) GetNewestReleases(uID, begin, end interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNewestReleases", reflect.TypeOf((*MockRepository)(nil).GetNewestReleases), uID, begin, end)
}
